...
const GeneralProfile = () => {
  return (
    ...
    <div className="lg:ml-[320px] max-lg:w-[full] max-lg:hidden">
      ...
      <div className="text-center mt-2 text-[14px]">Log & Upload all necessary information asked from you to complete your profile</div>
      <div className={`${button.tertiary} my-[22px]`}>Add your business card</div>
      </div>
      <div className="my-4 text-black bg-white rounded-lg w-[286px] h-[416px] px-4 py-6 overflow-x-hidden">
        <p className="text-lg font-semibold">Profile Shortcuts</p>
      ...
      text="Plan"/>
      <MenuItem icon={<><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
